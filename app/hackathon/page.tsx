...
const HackathonContent = () => {
    ...
    // We use the static 'hackathons' array below as the source of truth
    ...
    const handleParticipate = async (hackathon: Hackathon) => {
        ...
        if (isConnected) {
            ...
            try {
                ...
                showToastMessage('Registration failed: ' + (error instanceof Error ? error.message : 'Unknown error'), 'error');
            }
            setIsLoading(null);
            return;
        }
